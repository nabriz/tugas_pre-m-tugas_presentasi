...
<html lang="en">
    ...
    <head>
        ...
        <title>Tugas Presentasi Kelompok 2 - Implementasi Teknologi Komputasi Awan</title>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li>
                                    <a href="#pablo" class="dropdown-toggle" data-toggle="dropdown">
                                        <i class="material-icons">Implementasi Komputasi Awan</i>
                                        <p class="hidden-lg hidden-md">Implementasi Komputasi Awan</p>
                                    </a>
                                </li>
                                <li class="dropdown">
